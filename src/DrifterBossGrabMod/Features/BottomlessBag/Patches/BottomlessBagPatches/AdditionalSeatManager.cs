...
namespace DrifterBossGrabMod.Patches
{
    ...
    public static class AdditionalSeatManager
    {
        ...
        public static RoR2.VehicleSeat FindOrCreateEmptySeat(DrifterBagController bagController, ref ConcurrentDictionary<GameObject, RoR2.VehicleSeat> seatDict, bool ignoreCapacity = false)
        {
            ...
            if (!ignoreCapacity && totalAdditionalSeats >= currentCapacity - 1)
            {
                return null!;
            }
