    ...
    public static class TeleporterPatches
    {
        ...
        public static void PatchStaleReferences(TeleporterInteraction teleporter)
        {
            ...
            try
            {
                ...
                if (director != null && director.gameObject != null && PluginConfig.Instance.EnableDebugLogs.Value)
                {
                ...
                if (bossGroup != null && bossGroup.gameObject != null && PluginConfig.Instance.EnableDebugLogs.Value)
                {
                ...
                if (positionIndicator == null && PluginConfig.Instance.EnableDebugLogs.Value)
                {
