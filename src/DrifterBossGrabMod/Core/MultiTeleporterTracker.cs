    ...
    public static class MultiTeleporterTracker
    {
        ...
        public static void RegisterPrimary(TeleporterInteraction teleporter)
        {
            ...
            lock (_lock)
            {
                ...
                Log.Debug($"[MultiTeleporterTracker] Registered primary teleporter: {teleporter.gameObject.name} (InstanceID: {teleporter.GetInstanceID()})");
            }
        }
        ...
        public static void RegisterSecondary(TeleporterInteraction teleporter)
        {
            ...
            lock (_lock)
            {
                ...
                Log.Debug($"[MultiTeleporterTracker] Registered secondary teleporter: {teleporter.gameObject.name} (InstanceID: {teleporter.GetInstanceID()})");
            }
        }
        ...
        public static void UnregisterSecondary(TeleporterInteraction teleporter)
        {
            ...
            lock (_lock)
            {
                ...
                {
                    Log.Debug($"[MultiTeleporterTracker] Unregistered secondary teleporter: {teleporter.gameObject.name}");
                }
            }
        }
        ...
        public static void Clear()
        {
            ...
            lock (_lock)
            {
                ...
                _pendingInit.Clear();
                InvalidateCache();
                Log.Debug("[MultiTeleporterTracker] Cleared teleporter registry");
            }
        }
