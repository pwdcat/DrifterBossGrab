...
namespace DrifterBossGrabMod
{
    ...
    public partial class DrifterBossGrabPlugin
    {
        ...
        private void SyncFeatureTrackingState()
        {
            ...
            _wasRecoveryEnabled = PluginConfig.Instance.EnableRecoveryFeature.Value;
        ...
        private void InitializeFormulaVariables()
        {
            ...
            Balance.FormulaRegistry.RegisterVariable("MC",
                (body) => PluginConfig.Instance.ParsedMassCap,
        ...
        private void SetupAutoSwitchToCustomHandlers()
        {
            ...
            RegisterPresetOnlyHandlers(
                ...
                PluginConfig.Instance.CarouselOrientation,
                PluginConfig.Instance.CarouselSpacing,
                PluginConfig.Instance.CarouselAnimationDuration,
                PluginConfig.Instance.EnableCarouselInactivityFade,
                PluginConfig.Instance.CarouselInactivityFadeDelay,
                PluginConfig.Instance.CarouselInactivityFadeDuration,
                PluginConfig.Instance.CarouselInactivityFadeOpacity,
                ...
                PluginConfig.Instance.CenterSlotShowBackground,
                ...
                PluginConfig.Instance.SideSlotShowBackground,
